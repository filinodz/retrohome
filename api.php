...
require_once 'includes/social_api.php';
...
// --- FIN DE LA FONCTION getConsoles ---
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strpos($contentType, 'application/json') !== false) {
        ...
        $postData = $_POST;
        // Fallback for cases where $_POST might be empty but body has content
        if (empty($postData)) {
...
switch ($action) {
    ...
    case 'register':
        ...
        if (empty($username) || empty($password) || empty($email)) {
            error_log("Registration failed: Missing fields. Received: username='$username', email='$email', password=" . (empty($password) ? "empty" : "set"));
    ...
    case 'login':
        ...
        if (empty($username) || empty($password)) {
            error_log("Login failed: Missing fields. Received: username='$username', password=" . (empty($password) ? "empty" : "set"));
    ...
    case 'getRandomGame':
        ...
        break;
    // SOCIAL FEATURES API
    case 'getPublicProfile': handleGetPublicProfile(); break;
    case 'updateProfile': handleUpdateProfile($postData); break;
    case 'createPost': handleCreatePost($postData); break;
    case 'editPost': handleEditPost($postData); break;
    case 'deletePost': handleDeletePost($postData); break;
    case 'getPosts': handleGetPosts(); break;
    case 'likePost': handleLikePost($postData); break;
    case 'unlikePost': handleUnlikePost($postData); break;
    case 'addComment': handleAddComment($postData); break;
    case 'editComment': handleEditComment($postData); break;
    case 'getComments': handleGetComments(); break;
    case 'deleteComment': handleDeleteComment($postData); break;
    case 'followUser': handleFollowUser($postData); break;
    case 'unfollowUser': handleUnfollowUser($postData); break;
    case 'isFollowing': handleIsFollowing(); break;
