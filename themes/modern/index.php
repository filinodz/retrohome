...
<body>
    <div class="app-container">
        <header class="glass nav-bar animate__animated animate__fadeInDown">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <span class="pixel-text" style="font-size: 0.6rem; color: var(--text-muted);"><?= __('retro_system_ready') ?></span>
                </div>
            </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="hidden md:flex gap-6">
                    <div class="text-center">
                        ...
                        <div class="pixel-text" style="font-size: 0.5rem;"><?= __('stats_games') ?></div>
                    </div>
                    <div class="text-center">
                        <div id="stats-console-count" class="pixel-text" style="color: var(--accent); font-size: 1.2rem;">--</div>
                        <div class="pixel-text" style="font-size: 0.5rem;"><?= __('stats_consoles') ?></div>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div id="profile-menu" class="glass hidden" style="position: absolute; top: 100%; right: 0; mt: 10px; width: 200px; padding: 10px; z-index: 100;">
                        <a href="<?= SITE_URL ?>/profile" class="pixel-text" style="display: block; padding: 10px; color: white; text-decoration: none; font-size: 0.6rem;"><?= __('my_profile') ?></a>
                        <?php if($_SESSION['role'] === 'admin'): ?>
                            <a href="<?= SITE_URL ?>/admin/" class="pixel-text" style="display: block; padding: 10px; color: var(--accent); text-decoration: none; font-size: 0.6rem;"><?= __('admin_panel') ?></a>
                        <?php endif; ?>
                        <hr style="border: 0; border-top: 1px solid var(--glass-border); margin: 5px 0;">
                        <a href="#" id="logout-btn" class="pixel-text" style="display: block; padding: 10px; color: var(--primary); text-decoration: none; font-size: 0.6rem;"><?= __('logout') ?></a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="search-wrapper animate__animated animate__fadeInUp flex flex-col md:flex-row gap-4 mb-6">
            <div class="relative flex-1">
                <input type="text" id="game-search" class="search-input w-full" placeholder="<?= __('search_placeholder') ?>">
    ...
    <script>
        // Menu logic is now handled globally in script.js
    </script>
</body>
</html>
