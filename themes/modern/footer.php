    ...
    <div class="container mx-auto px-6">
        <div class="footer-grid grid grid-cols-1 md:grid-cols-3 gap-12 py-12 border-t border-white/10">
            ...
            <div class="footer-branding">
                ...
                <?php include BASE_PATH . '/includes/LanguageSelector.php'; ?>
            </div>

            <!-- Quick Links -->
            <div class="footer-links">
                <h4 class="font-bold text-white mb-6 uppercase tracking-wider text-xs"><?= __('quick_links') ?></h4>
                <ul class="space-y-3 text-sm opacity-60">
                    <li><a href="<?= SITE_URL ?>/" class="hover:text-primary transition-colors"><?= __('home') ?> / <?= __('library') ?></a></li>
                    <li><a href="<?= SITE_URL ?>/profile" class="hover:text-primary transition-colors"><?= __('profile') ?></a></li>
                    <li><a href="#" class="hover:text-primary transition-colors"><?= __('privacy_policy') ?></a></li>
                </ul>
            </div>

            <!-- Social/Contact -->
            <div class="footer-social">
                <h4 class="font-bold text-white mb-6 uppercase tracking-wider text-xs"><?= __('join_community') ?></h4>
        ...
        <div class="footer-bottom py-8 border-t border-white/5 text-center">
            <p class="text-xs opacity-40 uppercase tracking-[0.2em]">
                RetroHome <span class="mx-2">•</span> <?= __('made_with_love') ?> <span class="text-white font-bold">FilinoDZ</span>
            </p>
            <p class="text-[10px] opacity-20 mt-2 italic">
                &copy; <?= date('Y') ?> <?= SITE_NAME ?> Engine. <?= __('rights_reserved') ?>
            </p>
        </div>
    </div>
</footer>
