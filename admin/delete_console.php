...
// Récupération des paramètres de redirection (même si moins pertinent pour consoles, bonne pratique)
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
header("Location: ./"); // Pour les consoles, on revient généralement à la liste principale car pas de pagination/filtres complexes implémentés de la même façon pour l'instant
exit();
